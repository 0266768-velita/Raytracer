...
// holds all data parsed from an OBJ file
public class OBJModel {
    ...
    public List<Vector2D> getUvs()                             { return uvs; }
    public void           setUvs(List<Vector2D> uvs)           { this.uvs = uvs; }

    public List<Face>     getFaces()                           { return faces; }
    public void           setFaces(List<Face> faces)           { this.faces = faces; }

    public int getVertexCount() { return vertices.size(); }
    public int getNormalCount() { return normals.size();  }
    public int getUVCount()     { return uvs.size();      }
